define(['angular'], function (angular) {
    ...
    (function (angular) {
        ...
        var module = angular.module('dynamic-forms', []);
        ...
        function DynamicInputDirective(dynamicTemplates, $compile, $interpolate, validation) {
            return {
                ...
                link: function (scope, element, attrs, formCtrl) {
                    ...
                    inputElement = angular.element(template);
    ...
    angular.module("dynamic-forms").run(["$templateCache", function ($templateCache) {
